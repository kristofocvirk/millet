...
let primitive_function = function
  | Primitives.CompareIntEq -> comparison ( = )
  | Primitives.CompareIntLt -> comparison ( < )
  | Primitives.CompareIntGt -> comparison ( > )
  | Primitives.CompareIntLe -> comparison ( <= )
  | Primitives.CompareIntGe -> comparison ( >= )
  | Primitives.CompareIntNe -> comparison ( <> )
  | Primitives.CompareFloatEq -> comparison ( = )
  | Primitives.CompareFloatLt -> comparison ( < )
  | Primitives.CompareFloatGt -> comparison ( > )
  | Primitives.CompareFloatLe -> comparison ( <= )
  | Primitives.CompareFloatGe -> comparison ( >= )
  | Primitives.CompareFloatNe -> comparison ( <> )
